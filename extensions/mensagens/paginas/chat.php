	...
	<?php
		if(isset($_POST['env']) && $_POST['env'] == "envMsg"){
			...
			if(empty($mensagem)){
				...
				if(mysqli_query($conecta, "INSERT INTO mensagens (id_de, id_para, mensagem) VALUES ('$id_de', '$id_para', '$mensagem')") && mysqli_query($conecta, "INSERT INTO notifications (id_para, notificacao) VALUES ('$id_para', 'mensagem')")){			
				}else{
